...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-10" style={{ backgroundColor: '#e16f30' }}></div>
      </div>
      ...
      <div className="max-w-3xl relative z-10">
        ...
        {/* Main Heading */}
        <h1
          className={`font-bold leading-tight mb-4 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
          style={{ color: "#1a1a1a" }}
        >
          <span className="block text-5xl md:text-6xl lg:text-7xl hover:scale-105 transition-transform duration-500">
            Welcome & Joining
          </span>
          <span className="block text-5xl md:text-6xl lg:text-7xl mb-2 hover:scale-105 transition-transform duration-500">
            Kits
          </span>

          <span
            className="block text-3xl md:text-4xl lg:text-5xl italic font-semibold whitespace-nowrap hover:scale-105 transition-transform duration-500"
            style={{ color: "#df4607" }}
          >
        ...
        {/* Sub Heading */}
        <p className={`text-lg md:text-xl text-gray-700 leading-relaxed mb-10 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
        ...
        {/* CTA Buttons */}
        <div className={`flex flex-wrap gap-4 justify-start transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <button 
